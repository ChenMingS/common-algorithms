 ...
 * @description : 平衡二叉树排序
 * @from : https://blog.csdn.net/qq1137623160/article/details/101165605
 */
public class BalancedBinaryTreeSort {
...
//        int[] arr = { 10, 11, 7, 6, 8, 9, 20, 5, 28, 45, 32, 19, 17, 9 };
        // 创建一个 AVLTree 对象
    ...
    public void add(Node node) {
        ...
        if (rightHeight() - leftHeight() > 1) {
            ...
            if (right != null && right.leftHeight() > right.rightHeight()) {
                //先对右子结点进行右旋转
                right.rightRotate(); //然后在对当前结点进行左旋转
                leftRotate(); //左旋转..
            } else {
                //直接进行左旋转即可
                leftRotate();
